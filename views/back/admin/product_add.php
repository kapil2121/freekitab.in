                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border hide">
                                <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('sale_price');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="sale_price" id="demo-hor-6" min='0' value='0' step='.01' placeholder="<?php echo translate('sale_price');?>" class="form-control required">
                                </div>
                            ...
                            <div class="form-group btm_border hide">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="purchase_price" id="demo-hor-7" min='0' value='0' step='.01' placeholder="<?php echo translate('purchase_price');?>" class="form-control required">
                                </div>
                                <span class="btn"><?php echo currency(); ?> / </span>
                                <span class="btn unit_set"></span>
                            </div>
                        ...
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border hide" id="sub" style="display:none;">
